                ...
                <div>
                    ...
                    <div className="grid gap-2 p-1">
                        <button
                            ...
                            type="button"
                            className="w-1/2 mx-auto btn btn-lg btn-primary m-4 mb-1 h-20 rounded-lg bg-gray-200 text-black text-xl"
                        >
                    ...
                    {isLoading && (
                        <p className="text-center mb-6 text-2xl">
                            {" "}
                            El archivo <b>{file.name}</b> está siendo cargado
                        </p>
                    )}
                    ...
                    {!isLoading && showSuccessMessage && (
                        <p className="text-center text-2xl">
                            Archivo <b className="text-[#93166F]">{file.name}</b> cargado con
                            éxito
                        </p>
                    )}
                    ...
                    {!isLoading && hasFile && !showSuccessMessage && (
                        <p className="text-center text-2xl">
                            Archivo <b className="text-[#93166F]">{file.name}</b> cargado
                        </p>
                    )}
                </div>
            </section>
